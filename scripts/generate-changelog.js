...
console.log('📝 Generating embedded changelog from GitHub releases...');
...
https.get(options, (res) => {
  ...
  res.on('end', () => {
    try {
      ...
      console.log(`✅ Generated ${changelogPath} with ${changelog.releases.length} releases`);
      ...
      console.log(`✅ Generated ${changelogMdPath}`);
